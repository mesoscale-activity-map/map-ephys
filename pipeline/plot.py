...
def plot_unit_data(ipsi_hit, contra_hit, ipsi_err, contra_err):
    max_trial_off = 500
    binSize=0.04
    plt_xmin=-3
    plt_xmax=3
...
def plot_unit(unit_key):
    ...
    plot_unit_data(ipsi_hit_cell_psth, contra_hit_cell_psth, ipsi_err_cell_psth, contra_err_cell_psth)
