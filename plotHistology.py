...
a=(histology.ElectrodeCCFPosition() * (experiment.Session & 'rig = "RRig-MTL"')).fetch()

#%%
session_key=(experiment.Session & "subject_id='2897'" & "session='1'").fetch('KEY')
...
#%%
insert_key=(histology.ElectrodeCCFPosition() & "subject_id='3456'" & "session='7'" & "insertion_number='2'").fetch('KEY')

unit_ccf = (ephys.Unit * histology.ElectrodeCCFPosition.ElectrodePosition & insert_key).aggr(
